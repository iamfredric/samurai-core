 ...
 * @method static string|null wp_nav_menu(array $args = [])
 ...
 * @method static void add_image_size(string $name, int|null $width, int|null $height, bool|array $crop = false)
 ...
 * @method static \WP_Post|null get_post(int|\WP_Post|null $post = null, string $output = 'OBJECT', string $filter = 'raw')
 ...
 * @method static string|null get_previous_posts_link(string $label = null)
 * @method static string|null get_next_posts_link(string $label = null)
 * @method static string|null get_previous_posts_page_link()
 * @method static string|null get_next_posts_page_link()
